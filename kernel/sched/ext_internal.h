...
struct scx_sched {
	 ...
	 * with the kernel-side mapping address; the BPF-side uaddr is
	 * recovered by subtracting the arena's kern_vm_start. Grows on
	 * demand and pages are not released until sched destroy.
	 */
