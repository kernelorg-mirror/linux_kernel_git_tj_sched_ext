 ...
 */
__bpf_kfunc s32 scx_bpf_cpu_node(s32 cpu, const struct bpf_prog_aux *aux__prog)
{
...
scx_bpf_get_idle_cpumask_node(s32 node, const struct bpf_prog_aux *aux__prog)
{
	struct scx_sched *sch;
 ...
 */
__bpf_kfunc const struct cpumask *
scx_bpf_get_idle_smtmask_node(s32 node, const struct bpf_prog_aux *aux__prog)
{
	struct scx_sched *sch;
